import{wv as X,GS as Z,GT as ee,Ft as te,Fr as ie,GU as re,GV as ae,Fy as o,GL as se,G5 as oe,GK as ne,Fx as w,GW as ce,GX as le,Fu as pe,Fw as de,Fz as he,Gu as ve,FB as ue,GY as G,GZ as E,G_ as me,G$ as fe,G9 as ge,fH as Se,FC as Pe,FD as ye,_ as _e,FE as C,FF as N,FG as we,FH as R,FI as L,Gb as ze,FK as xe,FL as $e,FM as Te,FO as V,FP as be,H0 as Ve,H1 as U,H2 as H,H3 as ke,H4 as Oe,H5 as De,FQ as Fe,n as p,FR as d,fE as We,Gc as Ce,H6 as I,qH as Le,GC as Me,kT as je,FW as Ae,c9 as B,y5 as Ge,ge as q,ck as Y,H7 as Ee}from"./index-DmtZqjSm.js";function K(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
